...
type Props = {};
export const TestimonyImage = (props: Props) => {
  return (
        ...
        <div className='testimony__content'>
          <div className='testimony__text'>
            <p className='paragraph--medium'>
              Above all the wins, championships and awards, Joe Doe's legacy is his contribution to the discipline of
              coaching itself. His approach and techniques were revolutionary at the time, and had a deep impact that
