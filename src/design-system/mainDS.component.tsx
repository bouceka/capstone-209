  ...
  return (
    <main className={`main-ds card ${openMenu ? 'closed' : ''}`}>
      ...
      <p className="paragraph--medium">
        ...
        <span className="paragraph--medium--bold"> Organisms (Components).</span> This website contains the
        &quot;Atoms&quot; the building blocks for this app such as color pallette, spacing rules, and typography.
        Molecules are more complex elements that are combined from &quot;Atoms&quot; for instance buttons, field inputs,
        etc. Components are higher level elements that combine multiple molecules and create a functional piece of the
        app.
      </p>
      <p className="paragraph--medium">
        Every element either it is an atom or molecule is described as precise as possible which means that has a full
        description, external links that supports designer&apos;s decisions and includes code snippets for immediate
        usage within the project app.
      </p>
